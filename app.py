...
if not os.path.exists(MODEL_PATH):
    st.error(
        "Model file not found: models/best_model.joblib"
    )
    st.stop()
...
if not os.path.exists(PREPROCESSOR_PATH):
    st.error(
        "Preprocessor file not found: models/preprocessor.joblib"
    )
    st.stop()
...
if not os.path.exists(DATA_PATH):
    st.error(
        "Dataset not found: data/processed/cleaned_data.csv"
    )
    st.stop()
...
# =========================================================
    ...
    st.write(
        "Enter employee information to predict attrition risk."
    )
    ...
    if predict_button:
        ...
        try:
            ...
            for column in preprocessor["cat_cols"]:
                ...
                encoder = preprocessor["encoders"][column]
